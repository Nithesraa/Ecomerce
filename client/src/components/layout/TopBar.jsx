  ...
  return (
    <div className="w-full h-24 flex items-center justify-between px-10 border-b border-gray-100 dark:border-white/[0.04]">
      ...
      <div className="flex flex-col">
        ...
        <span className="text-[18px] font-medium text-gray-400">Orders Last 7 days</span>
      </div>
      ...
      <div className="hidden md:flex bg-gray-50 dark:bg-white/[0.02] p-1.5 rounded-full border border-gray-100 dark:border-white/[0.04]">
        {['Dashboard', 'Website'].map((tab) => (
          <button
            ...
            className={`px-8 py-2.5 rounded-full text-[18px] font-semibold transition-all ${
              activeTab === tab 
      ...
      <div className="flex items-center gap-6">
        ...
        <button className="flex items-center gap-2 px-4 py-2.5 bg-gray-50 dark:bg-white/[0.03] hover:bg-gray-100 transition-colors rounded-full border border-gray-100 dark:border-white/[0.06]">
          ...
          <span className="text-[17px] font-semibold text-gray-900 dark:text-white">Cart</span>
          {cartItemCount > 0 && (
            <span className="bg-blue-600 text-white w-5 h-5 flex items-center justify-center rounded-full text-[18px] font-bold ml-1">
              {cartItemCount}
            </span>
          )}
        </button>
        ...
        <div className="flex items-center">
          <div className="flex -space-x-2">
            ...
            <div className="w-9 h-9 rounded-full border-2 border-white dark:border-[#0F0F0F] bg-gray-100 flex items-center justify-center text-[17px] font-bold text-gray-600 z-10">
              +4
            </div>
          </div>
          <div className="ml-3 flex items-center gap-2">
            <img className="w-9 h-9 rounded-full" src="https://i.pravatar.cc/100?img=3" alt="Ryana" />
            <span className="text-[18px] font-semibold text-gray-900 dark:text-white">Ryana</span>
          </div>
        </div>
