      ...
      >
        ...
        <div className="relative w-full aspect-[4/5] bg-[#F6F6F6] dark:bg-[#111111] overflow-hidden flex items-center justify-center">
          ...
          <button 
            ...
            className="absolute bottom-0 inset-x-0 bg-black dark:bg-white text-white dark:text-black font-bold uppercase tracking-widest text-[17px] py-4 translate-y-full group-hover:translate-y-0 transition-transform duration-300 flex items-center justify-center gap-2"
          >
        ...
        <div className="flex flex-col mt-4">
          <div className="flex justify-between items-start gap-4">
            <h3 className="font-bold text-[17px] text-black dark:text-white leading-tight uppercase tracking-tight">
              {product.title}
            </h3>
          ...
          <p className="text-[18px] text-gray-500 font-medium mt-1">
