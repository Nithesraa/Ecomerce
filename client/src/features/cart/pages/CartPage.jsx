    ...
    <div className="w-full min-h-screen bg-white dark:bg-[#050505] text-black dark:text-white pt-32 pb-24 px-6 md:px-12">
      <div className="max-w-[1400px] mx-auto w-full">
        <div className="flex items-end justify-between border-b-2 border-black dark:border-white pb-6 mb-12">
          ...
          <span className="text-[18px] font-bold tracking-widest uppercase text-gray-500">{cartItems.length} Items</span>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-16 xl:gap-24 items-start">
          ...
          <div className="w-full lg:w-2/3 flex flex-col gap-8">
                ...
                <div className="flex-1 flex flex-col justify-between py-2">
                  <div className="flex justify-between items-start gap-4">
                    <div>
                      <Link 
                        ...
                        className="text-[18px] md:text-[20px] font-black uppercase tracking-tight text-black dark:text-white hover:underline leading-none mb-2 block"
                      >
                        {item.product?.title || 'Unknown Product'}
                      </Link>
                      <p className="text-[18px] font-bold tracking-widest text-gray-500 uppercase">
                  ...
                  <div className="flex items-end justify-between mt-6">
                    <div className="flex flex-col gap-2">
                      <span className="text-[17px] font-bold tracking-widest uppercase text-gray-500">Quantity</span>
                      <div className="flex items-center border border-[#E2E8F0] dark:border-white/[0.2] bg-transparent">
                        ...
                        <span className="w-10 text-center font-bold text-black dark:text-white text-[18px]">{item.quantity}</span>
                        <button 
                          onClick={() => item.product?._id && handleUpdateQuantity(item.product._id, item.quantity + 1)}
                          className="w-10 h-10 flex items-center justify-center text-gray-500 hover:text-black dark:hover:text-white transition-colors"
                        >
                    ...
                    <button 
                      ...
                      className="text-[17px] font-bold tracking-widest uppercase text-gray-400 hover:text-red-500 transition-colors flex items-center gap-1"
                    >
            ...
            <div className="flex justify-start pt-4">
              <button 
                onClick={() => navigate('/products')}
                className="text-[18px] font-bold tracking-widest uppercase text-black dark:text-white hover:underline transition-all"
              >
                ← Continue Shopping
              </button>
            </div>
          ...
          <div className="w-full lg:w-1/3 flex flex-col bg-gray-50 dark:bg-[#09090b] p-8 border border-[#E2E8F0] dark:border-white/[0.05]">
            ...
            <form onSubmit={handleApplyCoupon} className="flex mb-8 border-b border-[#E2E8F0] dark:border-white/[0.1] pb-8">
              <div className="relative flex-1">
                ...
                <input 
                  ...
                  className="w-full h-12 pl-12 pr-4 bg-white dark:bg-[#111111] border border-[#E2E8F0] dark:border-white/[0.1] text-[18px] font-bold tracking-widest uppercase outline-none focus:border-black dark:focus:border-white transition-colors text-black dark:text-white placeholder-gray-400"
                />
              </div>
              <button 
                type="submit"
                className="h-12 px-6 bg-black dark:bg-white text-white dark:text-black font-bold uppercase tracking-widest text-[17px] hover:opacity-80 transition-opacity whitespace-nowrap"
              >
                Apply
              </button>
            </form>
            ...
            <button 
              ...
              className="w-full h-16 bg-black dark:bg-white text-white dark:text-black font-black uppercase tracking-widest text-[18px] hover:opacity-80 transition-opacity flex items-center justify-center gap-3"
            >
              Checkout
            </button>
            <p className="text-center text-[17px] font-bold tracking-widest text-gray-500 uppercase mt-4">
